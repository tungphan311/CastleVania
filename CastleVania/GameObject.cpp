...
void GameObject::RenderBoundingBox()
{
	...
	Game::GetInstance()->Draw(-1, l , t , bbox, rect.left, rect.top, rect.right, rect.bottom, 100);
}

bool GameObject::SweptAABBExtend(float aLeft, float aTop, float aRight, float aBot, float bLeft, float bTop, float bRight, float bBot)
{
